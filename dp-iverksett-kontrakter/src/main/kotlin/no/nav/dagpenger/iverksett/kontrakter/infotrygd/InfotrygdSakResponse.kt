...
enum class InfotrygdSakType(val infotrygdKode: String, val beskrivelse: String) {
    ...
    GRUNNBELØP_OMREGNING_DAGPENGER("GO", "Grunnbeløp omregning (manuell G-omregning) Dagpenger"),
    ...
    MASKINELL_G_OMREGNING("MG", "Maskinell G-omregning (Årlig G-reg. Dagpenger)"),
    MASKINELL_SATSOMREGNING("MS", "Maskinell Satsomregning (Årlig satsendring Dagpenger)"),
