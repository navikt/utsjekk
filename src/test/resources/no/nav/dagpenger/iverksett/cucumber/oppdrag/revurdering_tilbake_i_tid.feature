...
Egenskap: Revurdering tilbake i tid
  ...
  Scenario: Revurdering tilbake i tid før vi hadde beløp
    ...
    Så forvent følgende utbetalingsoppdrag
      ...
      | 2            | 01.02.2021 | 01.02.2021 | 01.01.2021  | 700   | ENDR         | Ja         | 1          |                    |
    ...
    Så forvent følgende tilkjente ytelser for behandling 2 med startdato 01.01.2021
      | Fra dato | Til dato | Beløp | Periode id | Forrige periode id | Kilde behandling id |
      |          |          | 0     | 1          |                    | 2                   |
  ...
  Scenario: Revurdering tilbake i tid med beløp
    ...
    Så forvent følgende utbetalingsoppdrag
      ...
      | 1            |01.02.2021 |01.02.2021 |             | 700   | NY           | Nei        | 1          |                    |
      | 2            |01.02.2021 |01.02.2021 |01.01.2021    | 700   | ENDR         | Ja         | 1          |                    |
      | 2            |01.01.2021 |01.01.2021 |             | 600   | ENDR         | Nei        | 2          | 1                  |
    ...
    Så forvent følgende tilkjente ytelser for behandling 2 med startdato 01.01.2021
      | Fra dato | Til dato | Beløp | Periode id | Forrige periode id | Kilde behandling id |
      |01.01.2021 |01.01.2021 | 600   | 2          | 1                  | 2                   |