...
Egenskap: Ulike stønadstyper på andelene
  ...
  Scenario: Søker med ordinær arbeidssøker og permittering
    ...
    Så forvent følgende utbetalingsoppdrag
      ...
      | 1            | 01.03.2021 | 01.03.2021 |             | 700   | DAGPENGER_ARBEIDSSØKER_ORDINÆR | NY           | Nei        | 0          |                    |
      | 1            | 01.03.2021 | 01.03.2021 |             | 800   | DAGPENGER_PERMITTERING_ORDINÆR | NY           | Nei        | 1          |                    |
  ...
  Scenario: Revurdering endrer beløp på permittering fra april
    ...
    Så forvent følgende utbetalingsoppdrag
      | BehandlingId | Fra dato   | Til dato   | Opphørsdato | Beløp | Ytelse                          | Kode endring | Er endring | Periode id | Forrige periode id |
      | 1            | 01.03.2021 | 01.05.2021 |             | 700   | DAGPENGER_ARBEIDSSØKER_ORDINÆR | NY           | Nei        | 0          |                    |
      | 1            | 01.03.2021 | 01.05.2021 |             | 800   | DAGPENGER_PERMITTERING_ORDINÆR | NY           | Nei        | 1          |                    |
      | 2            | 01.04.2021 | 01.05.2021 |             | 900   | DAGPENGER_PERMITTERING_ORDINÆR | ENDR         | Nei        | 2          | 1                  |
  ...
  Scenario: Søker har flere stønadstyper som alle blir egne kjeder. Øker hvert beløp med 100kr i revurderingen for å verifisere at det fortsatt blir 3 ulike kjeder
    ...
    Så forvent følgende utbetalingsoppdrag
      | BehandlingId | Fra dato   | Til dato   | Opphørsdato | Beløp | Ytelse                          | Kode endring | Er endring | Periode id | Forrige periode id |
      | 1            | 01.03.2021 | 01.03.2021 |             | 100   | DAGPENGER_ARBEIDSSØKER_ORDINÆR | NY           | Nei        | 0          |                    |
      | 1            | 01.03.2021 | 01.03.2021 |             | 200   | DAGPENGER_PERMITTERING_ORDINÆR | NY           | Nei        | 1          |                    |
      | 1            | 01.03.2021 | 01.03.2021 |             | 300   | DAGPENGER_EØS                   | NY           | Nei        | 2          |                    |
      | 2            | 01.03.2021 | 01.03.2021 |             | 200   | DAGPENGER_ARBEIDSSØKER_ORDINÆR | ENDR         | Nei        | 3          | 0                  |
      | 2            | 01.03.2021 | 01.03.2021 |             | 300   | DAGPENGER_PERMITTERING_ORDINÆR | ENDR         | Nei        | 4          | 1                  |
      | 2            | 01.03.2021 | 01.03.2021 |             | 400   | DAGPENGER_EØS                   | ENDR         | Nei        | 5          | 2                  |
