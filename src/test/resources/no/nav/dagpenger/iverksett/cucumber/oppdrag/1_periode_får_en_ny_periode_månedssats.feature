...
Egenskap: Månedssats, enkelt scenario
  ...
  Scenario: Har en periode, legger til en ny
    ...
    Gitt følgende tilkjente ytelser
      ...
      | 1            | 01.02.2021 | 31.03.2021 | 700   | MND      |
      | 2            | 01.02.2021 | 31.03.2021 | 700   | MND      |
      | 2            | 01.04.2021 | 31.05.2021 | 900   | MND      |
    ...
    Så forvent følgende utbetalingsoppdrag
      ...
      | 1            | 01.02.2021 | 31.03.2021 |             | 700   | NY           | Nei        | 0          |                    | MND      |
      | 2            | 01.04.2021 | 31.05.2021 |             | 900   | ENDR         | Nei        | 1          | 0                  | MND      |
