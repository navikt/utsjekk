...
import no.nav.dagpenger.kontrakter.iverksett.BehandlingType.FØRSTEGANGSBEHANDLING
import no.nav.dagpenger.kontrakter.iverksett.BehandlingType.REVURDERING
import no.nav.dagpenger.kontrakter.iverksett.BehandlingÅrsak.NYE_OPPLYSNINGER
import no.nav.dagpenger.kontrakter.iverksett.BehandlingÅrsak.SØKNAD
import no.nav.dagpenger.kontrakter.iverksett.Vedtaksresultat.AVSLÅTT
import no.nav.dagpenger.kontrakter.iverksett.Vedtaksresultat.INNVILGET
import no.nav.dagpenger.kontrakter.iverksett.Vedtaksresultat.OPPHØRT
