...
internal class TilbakekrevingMapperTest {
    ...
    fun `konverter Iverksetting til Hentfagsystembehandling`() {
        ...
        assertThat(fagsystemsbehandling.sakId).isEqualTo(iverksett.fagsak.fagsakId.sakId)
        assertThat(fagsystemsbehandling.saksreferanse).isEqualTo(iverksett.fagsak.fagsakId.saksreferanse)
