...
import no.nav.dagpenger.iverksett.infrastruktur.util.MDCConstants.MDC_CALL_ID
import no.nav.dagpenger.iverksett.infrastruktur.util.MDCConstants.MDC_CONSUMER_ID
import no.nav.dagpenger.iverksett.infrastruktur.util.MDCConstants.MDC_REQUEST_ID
import no.nav.dagpenger.iverksett.infrastruktur.util.MDCConstants.MDC_USER_ID
